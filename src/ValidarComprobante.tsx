        ...
        <div className="bg-gray-700 p-6 rounded-xl mb-6 border border-gray-600">
          ...
          <div className="space-y-3">
            ...
            <div className="flex justify-between items-center">
              ...
              <span className="text-white">{driverData.email}</span>
            </div>

            <div className="flex justify-between items-center">
              <span className="text-gray-400 font-medium">ID Zello:</span>
              <span className="text-white">{driverData.idZello}</span>
            </div>
          </div>
        </div>
